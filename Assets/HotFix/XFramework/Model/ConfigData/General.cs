...
namespace XFramework
{
    ...
    public static partial class General
    {
        ...
        [LabelText("文件下载路径")] public const string DownFilePath = "HotFix/XFramework/Resources/DownFile/DownFileInfo.Json";
        ...
        [LabelText("BaseWindow模板地址")] public static string BaseWindowTemplatePath = "Assets/HotFix/XFramework/Model/Template/BaseWindowTemplate.cs";

        [LabelText("ChildBaseWindow模板地址")] public static string ChildBaseWindowTemplatePath = "Assets/HotFix/XFramework/Model/Template/ChildBaseWindowTemplate.cs";

        [LabelText("CircuitBaseData模板地址")] public static string CircuitBaseDataTemplatePath = "Assets/HotFix/XFramework/Model/Template/CircuitBaseDataTemplate.cs";

        [LabelText("ListenerComponentData模板地址")]
        public static string ListenerComponentDataTemplatePath = "Assets/HotFix/XFramework/Model/Template/ListenerComponentDataTemplate.cs";

        [LabelText("SceneLoadComponent模板地址")] public static string SceneComponentTemplatePath = "Assets/HotFix/XFramework/Model/Template/SceneComponentTemplate.cs";

        [LabelText("SceneLoadComponentInit模板地址")]
        public static string SceneComponentInitTemplatePath = "Assets/HotFix/XFramework/Model/Template/SceneComponentInitTemplate.cs";

        [LabelText("AnimatorControllerParameterData模板地址")]
        public static string AnimatorControllerParameterDataTemplatePath = "Assets/HotFix/XFramework/Model/Template/AnimatorControllerParameterDataTemplate.cs";
