...
#pragma warning restore 649
        ...
        private void LoadSynchronizationScene(string sceneName)
        {
            ...
            TimeComponent.Instance.EndComponent();
        ...
        {
            AssetBundle SceneLoadInfoAb = AssetBundle.LoadFromFile(Application.streamingAssetsPath + "/" + "sceneloadinfo");
            SceneLoadInfoAb.Unload(true);

            SceneFile sceneFile = JsonMapper.ToObject<SceneFile>(SceneLoadInfoAb.LoadAsset<TextAsset>("SceneLoadInfo").text);
