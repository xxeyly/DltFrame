...
namespace XFramework
{
    ...
    public class CustomFrameHierarchyLogo
    {
        ...
        static CustomFrameHierarchyLogo()
        {
            ...
            XFrameworkLOGO = AssetDatabase.LoadAssetAtPath<Texture>("Assets/XFramework/Editor/View/Texture/Root.png");
            ...
            XFrameworkLOGOTitle = AssetDatabase.LoadAssetAtPath<Texture>("Assets/XFramework/Editor/View/Texture/XFramework.png");
