...
namespace XFramework
{
    public static partial class General
    {
        ...
        [LabelText("ListenerComponentData模板地址")] public static string ListenerComponentDataTemplatePath = XFrameworkPath + "Model/Template/ListenerComponentDataTemplate.cs";
        ...
        [LabelText("SceneLoadComponentInit模板地址")] public static string SceneComponentInitTemplatePath = XFrameworkPath + "Model/Template/SceneComponentInitTemplate.cs";
        [LabelText("AnimatorControllerParameterData模板地址")] public static string AnimatorControllerParameterDataTemplatePath = XFrameworkPath + "Model/Template/AnimatorControllerParameterDataTemplate.cs";
