...
namespace XFramework
{
    ...
    public class EditorEntityComponentDataInfo
    {
        ...
        {
            EntityComponent entityComponent = UnityEngine.Object.FindObjectOfType<EntityComponent>();
            entityComponent.DisplayEditorEntityGroup(entityGroupTag, true, true);
        }
    }

    public partial class EntityComponent : ComponentBase
    {
