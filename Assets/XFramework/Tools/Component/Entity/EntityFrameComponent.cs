...
namespace XFramework
{
    ...
    public partial class EntityFrameComponent : FrameComponent
    {
        ...
        public List<EntityComponentDataInfo> entityComponentDataInfos = new List<EntityComponentDataInfo>();

        [TableList(AlwaysExpanded = true, DrawScrollView = false)] [LabelText("编辑器实体组")]
        public List<EditorEntityComponentDataInfo> editorEntityComponentDataInfos = new List<EditorEntityComponentDataInfo>();
