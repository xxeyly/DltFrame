...
namespace XFramework
{
    ...
    {
        public static MouseComponent Instance;
...
#pragma warning restore
        ...
        private void Update()
        {
            ...
            {
                mouseDown = true;
                AudioComponent.Instance.PlayEffectAudio("点击");
            }
        ...
        public void StartUiFollowingMouse(GameObject targetObj, Vector2 offset = new Vector2())
        {
            ...
            _objectFollowingMouseTaskTime =
                TimeComponent.Instance.AddTimeTask(() => { UiFollowingMouse(targetObj, offset); }, "UI拖拽任务", 0.00f, 0);
        }
        ...
        {
            TimeComponent.Instance.DeleteTimeTask(_objectFollowingMouseTaskTime);
        }
        ...
        public void MouseEnterState()
        {
            ...
            if (RuntimeDataComponent.Instance.mouseState)
            {
            ...
            float frontDirection, float backDirection)
        {
            ...
            {
                Debug.Log(hit.collider.gameObject);
                TimeComponent.Instance.DeleteTimeTask(_drag3DObjectInUIPanelTimeTask);
                _drag3DObjectInUIPanelTimeTask = TimeComponent.Instance.AddTimeTask(() =>
                {
