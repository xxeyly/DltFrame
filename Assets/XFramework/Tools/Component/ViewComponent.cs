...
namespace XFramework
{
    ...
    {
        public static ViewComponent Instance;
        ...
        {
            _viewTimeTaskId = TimeComponent.Instance.AddTimeTask(() => { viewAction.Invoke(viewType); }, "视图任务", time);
        }
        ...
        {
            TimeComponent.Instance.DeleteTimeTask(_viewTimeTaskId);
        }
