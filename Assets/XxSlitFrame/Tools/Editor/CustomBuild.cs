    ...
    public class CustomBuild : EditorWindow
    {
        ...
        private void InitData()
        {
            if (File.Exists(Application.dataPath + "/Resources/BuildData.json"))
            {
                ...
                _projectBuildEdition = buildData.projectEdition;
        ...
        /// 项目类型
        /// </summary>
        private EProjectEdition _projectBuildEdition;
        ...
        public void OnGUI()
        {
            ...
            //自定义枚举下拉框
            EditorGUILayout.LabelField("选择当前项目类型:", GUILayout.MaxWidth(100));
            _projectBuildEdition = (EProjectEdition) EditorGUILayout.EnumPopup(this._projectBuildEdition, GUILayout.MaxWidth(150));
            ...
            _enableProjectEdition = EditorGUILayout.Toggle("", _enableProjectEdition, GUILayout.MaxWidth(10));
        ...
        private void SaveBuildData()
        {
            BuildData buildData = new BuildData
            {
                ...
                projectEdition = _projectBuildEdition,
                copyFolderCount = _copyFolderCount,
                copyFolderPaths = _copyFolderPaths,
                exportProjectName = _exportProjectName,
                pasteFolderPaths = _pasteFolderPaths,
                projectNameDate = _enableProjectNameDate,
                projectOffline = _enableProjectOffline,
                projectBuildEdition = _enableProjectEdition,
                updateToFtp = _updateToFtp,
        ...
        private string ProjectPath()
        {
            ...
            if (_enableProjectEdition)
            {
                switch (_projectBuildEdition)
                {
