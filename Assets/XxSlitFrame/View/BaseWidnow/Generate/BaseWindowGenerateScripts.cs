...
#if UNITY_EDITOR
#pragma warning disable 0414
        static MethodInfo _clearMethod = null;
#pragma warning restore 0414
        /// <summary>
        /// 清空log信息
        /// </summary>
        ...
        public void OneClickGetOldAction()
        {
            ...
            foreach (KeyValuePair<string, string> pair in _listenerActionList)
            {
                Debug.Log(pair + ":" + pair.Value);
            }
        }
        ...
        public void OneClickStatementListener()
        {
            ...
            foreach (KeyValuePair<string, string> keyValuePair in _listenerActionList)
            {
